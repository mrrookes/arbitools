...
def main(argv):
        ...
        listfile=os.path.expanduser("~")+"custom_elo.csv" #TESTING
        elolist='custom'
        method=''
        listdata=''
        inputfile=''
        ...
        for opt, arg in opts:
                ...
                #        silent_mode = True
                        ...
                        if elolist == 'feda':
                                if xlrd_present==True:
                                        listfile = os.path.expanduser("~")+"elo_feda.xls" #TESTING
                                else:
                                        print("To search feda list you need to install xlrd module.")
                                        sys.exit()
                        elif elolist == 'fidefeda':
                        
                                listfile = os.path.expanduser("~")+"FIDE-FEDA Vega.csv" #TESTING
                        elif elolist == 'fide':
                                if lxml_present==True:
                                        listfile = os.path.expanduser("~")+"players_list_xml.xml" #TESTING
                                else:
                ...
                #                sys.exit()
                        ...
                        inputfile = os.getcwd()+arg #TESTING
